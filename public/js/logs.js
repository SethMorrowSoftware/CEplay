...
(function() {
    ...
    function buildFiltersBar() {
        ...
        ['cron', 'manual', 'override', 'schedule', 'game-status', 'birthdays', 'anniversaries'].forEach(s => {
        ...
        ['pause', 'unpause', 'skip', 'plan_day', 'execute_action', 'game_tagged_out', 'game_enabled', 'game_paused', 'unpause_all', 'birthday_posted', 'birthday_failed', 'anniversary_posted', 'anniversary_failed'].forEach(a => {
