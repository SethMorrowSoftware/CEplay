    ...
    try {
        switch ($resource) {
            ...
            case 'tickets':
                ...
                handleTickets($method, $parts, $input);
                break;
            case 'revenue':
                ...
                break;
            case 'redemption':
                require_once __DIR__ . '/api/redemption.php';
                handleRedemption($method, $parts, $input);
                break;
            case 'promotions':
...
<body>
    ...
    <script defer src="<?= assetUrl($basePath, '/public/js/tickets.js') ?>"></script>
