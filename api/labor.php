...
// Defaults for THIS venue, taken verbatim from the operator's working
// Grafana query: go-kart sales are category 108; go-kart labor is every
// punch whose TimeClock_JobCodes description is 'Go-Karts', costed to the
// second from actual clock-in/out timestamps. $__timeFilter(col) in the
// Grafana original maps to `col = :date` here (the page runs each query
