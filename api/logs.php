...
const LOG_FILTER_SOURCES = [
    ...
    'kiosk-patch', 'kiosk-action', 'kiosk-sync', 'kiosk-unpause-all', 'kiosk-pause-all',
    'game-action', 'game-patch', 'game-sync', 'game-poll', 'game-unpause-all', 'game-pause-all',
...
const LOG_FILTER_ACTIONS = [
    ...
    'game_action_performed', 'games_unpause_all', 'games_pause_all',
    // Kiosks
    'kiosk_status_changed', 'kiosk_action_failed', 'kiosk_bulk_patch',
    'kiosk_action_performed', 'kiosks_sync_triggered', 'kiosks_unpause_all', 'kiosks_pause_all',
    // Cards
